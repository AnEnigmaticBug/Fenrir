...
import kotlinx.android.synthetic.main.fra_get_money.view.*

class GetMoneyFragment : Fragment() {

    private lateinit var navigationHost: NavigationHost
    private lateinit var viewModel: GetMoneyViewModel
    private lateinit var rootPOV: View

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        navigationHost = parentFragment as NavigationHost

        viewModel = ViewModelProviders.of(this, GetMoneyViewModelFactory())[GetMoneyViewModel::class.java]

        rootPOV = inflater.inflate(R.layout.fra_get_money, container, false)
